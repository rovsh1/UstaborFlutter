...
class ActiveMasterTab extends StatelessWidget {
  final MyApplicationDetail application;
  final Function hideMaster;

  ActiveMasterTab({required this.application, required this.hideMaster});

  @override
  Widget build(BuildContext context) {
    final masterList = application.masters!.where((element) => element.status == 2).toList();
                ...
                SizedBox(
                  ...
                  child: RotatedBox(
                    ...
                    child: PopupMenuButton<String>(
                      onSelected: (_) {
                        hideMaster(masterList[index].id ?? 0);
                      },
                      elevation: 10.0,
